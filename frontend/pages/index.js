// u-pal bilingual chatbot interface - next.js page component
// features: live chat with verified source attribution, bilingual (en/cy) auto-detect,
// translate button, chat history, responsive design, accessibility.
// backend calls /api/chat for each message, renders bot reply + source links.
                            ...
                            {msg.role === 'bot' && msg.sources && msg.sources.length > 0 && (() => {
                              ...
                              return validSources.length > 0 ? (
                                <details className="msg-sources">
                                  <summary className="msg-sources-summary">
                                    {msg.lang === 'cy' ? 'Ffynonellau' : 'Sources'} ({validSources.length})
                                  </summary>
                                  <div className="msg-sources-list">
                                    {validSources.map((src, i) => (
                                      <div key={i} className="msg-source-item">
                                        <div className="msg-source-header">
                                          <div className="msg-source-title">{src.title}</div>
                                          <div className="msg-source-category">{src.category}</div>
                                        </div>
